<style>
    ...
    nav a {
        ...
        /* Làm cho hàng chữ thanh mảnh hơn */
        display: block;
...
<aside class="fixed top-0 left-0 h-screen bg-black/95 border-r border-white/5 flex flex-col z-50 shadow-2xl custom-scrollbar">
    ...
    <nav class="flex-grow py-4 px-2 space-y-2">
        ...
        <a href="manifesto.php" class="flex items-center gap-4 px-2 py-3 text-gray-500 hover:text-cyan-400 transition-all group">
            <i class="fa-solid fa-house min-w-[1.2rem] text-center text-sm"></i>
            <span class="menu-text font-bold uppercase">Manifesto</span>
        </a>


        <a href="n8n_dashboard.php" class="flex items-center gap-4 px-2 py-3 text-gray-500 hover:text-cyan-400 transition-all group">
            <i class="fa-solid fa-house min-w-[1.2rem] text-center text-sm"></i>
            <span class="menu-text font-bold uppercase">n8n Dashboard của tôi</span>
        </a>
        ...
        <a href="marketplace.php" class="flex items-center gap-4 px-2 py-3 text-white bg-white/5 rounded-lg border border-white/10">
            <i class="fa-solid fa-compass min-w-[1.2rem] text-center text-sm text-cyan-400"></i>
            <span class="menu-text font-bold uppercase">Galleries from HungLouis</span>
        </a>
        ...
        <a href="wallet.php" class="flex items-center gap-3 px-2 py-3 text-gray-500 hover:text-yellow-500 transition-all">
            ...
            <span class="menu-text font-bold uppercase">Tài Khoản</span>
        </a>
		...
		<a href="https://web3.okx.com/vi/nft/asset/polygon/" class="flex items-center gap-3 px-2 py-3 text-gray-500 hover:text-yellow-500 transition-all">
            <i class="fa-solid fa-circle-nodes min-w-[1.2rem] text-center text-sm"></i>
            <span class="menu-text font-bold uppercase">OKX_WEB3</span>
        </a>
