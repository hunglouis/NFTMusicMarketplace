...
$fullUrl = $supabaseUrl . "/rest/v1/items?select=*&order=id.asc&limit=50&is_hidden=eq.false";
                ...
                <div class="music-card-php"
                    ...
                    <div class="relative h-56 w-full mb-4 overflow-hidden rounded-2xl group">
                        <a href="<?php echo createSlug($item['name'], $item['id']); ?>" class="block h-full w-full">
                            <img src="<?php echo !empty($item['image_url']) ? $item['image_url'] : 'assets/images/louis-music-default.jpg';  ?>" class="w-full h-full object-cover">
                    ...
                    <div class="flex-grow">
                        ...
                        <div class="flex justify-between items-center bg-white/5 p-3 rounded-xl">
                            ...
                            <span class="text-emerald-400 font-black">💰 <?php echo $item['price'] ?? '0'; ?> MATIC</span>
                        </div>
                    </div>

                    <!-- Nút hành động -->
                    <div class="grid grid-cols-2 gap-3 mt-5">
                        <button onclick="playMusic('<?php echo isset($item['image_url']); ?>', '<?php echo addslashes($item['collection_name'] ?? '0'); ?>', '<?php echo isset($item['image_url']); ?>')"
